...
public:
    ...
    /**
     * @brief Sets address of the packet's sender.
     */
    void setSourceAddress(LAddress::L2Type sourceAddress)
    {
     ...
     */
    LAddress::L2Type getSourceAddress() const
    {
